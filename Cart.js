(function () {
  ...
  const WHATSAPP_NUMBER = '26700000000'; // Replace with your actual number
  ...
  // ── ADD TO CART (called from Shop page) ──
  ...
  function renderCart() {
    ...
    if (cart.length === 0) {
      list.innerHTML = '<div class="cart-empty"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg><p>Your cart is empty</p></div>';
  ...
  window.sendWhatsAppOrder = function () {
    ...
    if (!name || !phone || !payment) {
      document.getElementById('co-error').textContent = 'Please fill in all fields.';
      return;
    }
  ...
  function injectDrawer() {
    ...
    // Sync co-total-display with cart total when checkout view opens
    const origShow = window.showCheckoutView;
